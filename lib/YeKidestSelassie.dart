...
class YeKidestSelassie extends StatefulWidget {
   YeKidestSelassie({super.key});

  @override
  State<YeKidestSelassie> createState() => _YeKidestSelassieState();
}

class _YeKidestSelassieState extends State<YeKidestSelassie> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidestSelassie").snapshots(),
