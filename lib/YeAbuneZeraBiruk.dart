...
class YeAbuneZerabiruk extends StatefulWidget {
   YeAbuneZerabiruk({super.key});

  @override
  State<YeAbuneZerabiruk> createState() => _YeAbuneZerabirukState();
}

class _YeAbuneZerabirukState extends State<YeAbuneZerabiruk> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeZeraBiruk").snapshots(),
