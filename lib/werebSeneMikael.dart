...
class werebSeneMikael extends StatefulWidget {
   werebSeneMikael({super.key});

  @override
  State<werebSeneMikael> createState() => _werebSeneMikaelState();
}

class _werebSeneMikaelState extends State<werebSeneMikael> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebSeneMikael").snapshots(),
