...
class werebGena extends StatefulWidget {
   werebGena({super.key});

  @override
  State<werebGena> createState() => _werebGenaState();
}

class _werebGenaState extends State<werebGena> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebGena").snapshots(),
