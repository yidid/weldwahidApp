...
class WerebMeyaziyaGiorgis extends StatefulWidget {
   WerebMeyaziyaGiorgis({super.key});

  @override
  State<WerebMeyaziyaGiorgis> createState() => _WerebMeyaziyaGiorgisState();
}

class _WerebMeyaziyaGiorgisState extends State<WerebMeyaziyaGiorgis> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebMiyaziyaGeorgis").snapshots(),
