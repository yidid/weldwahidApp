...
class AbuneGebereMenfesKidus extends StatefulWidget {
   AbuneGebereMenfesKidus({super.key});

  @override
  State<AbuneGebereMenfesKidus> createState() => _AbuneGebereMenfesKidusState();
}

class _AbuneGebereMenfesKidusState extends State<AbuneGebereMenfesKidus> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeAbuneGebereMeneskidus").snapshots(),
