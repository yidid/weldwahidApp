...
class werebHidarGiorgis extends StatefulWidget {
   werebHidarGiorgis({super.key});

  @override
  State<werebHidarGiorgis> createState() => _werebHidarGiorgisState();
}

class _werebHidarGiorgisState extends State<werebHidarGiorgis> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHidarGiorgis").snapshots(),
