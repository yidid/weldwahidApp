...
class werebHamleSelassie extends StatefulWidget {
   werebHamleSelassie({super.key});

  @override
  State<werebHamleSelassie> createState() => _werebHamleSelassieState();
}

class _werebHamleSelassieState extends State<werebHamleSelassie> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHamleSelassie").snapshots(),
