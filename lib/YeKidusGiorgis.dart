...
class YeKidusGiorgis extends StatefulWidget {
   YeKidusGiorgis({super.key});

  @override
  State<YeKidusGiorgis> createState() => _YeKidusGiorgisState();
}

class _YeKidusGiorgisState extends State<YeKidusGiorgis> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("yekidusgiorgismezmur").snapshots(),
