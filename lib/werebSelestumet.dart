...
class WerebSelestuMet extends StatefulWidget {
   WerebSelestuMet({super.key});

  @override
  State<WerebSelestuMet> createState() => _WerebSelestuMetState();
}

class _WerebSelestuMetState extends State<WerebSelestuMet> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebSelestuMet").snapshots(),
