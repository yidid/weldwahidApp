...
class WerebHidarMikael extends StatefulWidget {
   WerebHidarMikael({super.key});

  @override
  State<WerebHidarMikael> createState() => _WerebHidarMikaelState();
}

class _WerebHidarMikaelState extends State<WerebHidarMikael> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHidarMikael").snapshots(),
