...
class WerebMeskel extends StatefulWidget {
   WerebMeskel({super.key});

  @override
  State<WerebMeskel> createState() => _WerebMeskelState();
}

class _WerebMeskelState extends State<WerebMeskel> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebMeskel").snapshots(),
