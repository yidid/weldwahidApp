...
class werebTahisasGebreal extends StatefulWidget {
   werebTahisasGebreal({super.key});

  @override
  State<werebTahisasGebreal> createState() => _werebTahisasGebrealState();
}

class _werebTahisasGebrealState extends State<werebTahisasGebreal> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebTahisasGebreal").snapshots(),
