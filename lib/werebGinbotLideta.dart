...
class werebGInbotLideta extends StatefulWidget {
   werebGInbotLideta({super.key});

  @override
  State<werebGInbotLideta> createState() => _werebGInbotLidetaState();
}

class _werebGInbotLidetaState extends State<werebGInbotLideta> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebGinbotLideta").snapshots(),
