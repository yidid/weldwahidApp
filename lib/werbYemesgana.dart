...
class werebYemesgana extends StatefulWidget {
   werebYemesgana({super.key});

  @override
  State<werebYemesgana> createState() => _werebYemesganaState();
}

class _werebYemesganaState extends State<werebYemesgana> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebYemesgana").snapshots(),
