...
class WerebSerg extends StatefulWidget {
   WerebSerg({super.key});

  @override
  State<WerebSerg> createState() => _WerebSergState();
}

class _WerebSergState extends State<WerebSerg> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebSerg").snapshots(),
