...
class YesergList extends StatefulWidget {
   YesergList({super.key});

  @override
  State<YesergList> createState() => _YesergListState();
}

class _YesergListState extends State<YesergList> {
   var height,width;
              ...
              child: Padding(
                ...
                child:
                 ...
                 InkWell(
                  onTap: () {
                    Navigator.push(
                      context, MaterialPageRoute(builder: ((context) => YesergRejim())));
                  ...
                  onTap: () {
                    Navigator.push(
                      context, MaterialPageRoute(builder: ((context) => Yeserg())));
