...
class YeMaru extends StatefulWidget {
   YeMaru({super.key});

  @override
  State<YeMaru> createState() => _YeMaruState();
}

class _YeMaruState extends State<YeMaru> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeMaru").snapshots(),
