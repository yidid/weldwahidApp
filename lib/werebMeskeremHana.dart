...
class WerebMeskeremHana extends StatefulWidget {
   WerebMeskeremHana({super.key});

  @override
  State<WerebMeskeremHana> createState() => _WerebMeskeremHanaState();
}

class _WerebMeskeremHanaState extends State<WerebMeskeremHana> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebMeskerem7").snapshots(),
