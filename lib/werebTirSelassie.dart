...
class werebTirSelassie extends StatefulWidget {
   werebTirSelassie({super.key});

  @override
  State<werebTirSelassie> createState() => _werebTirSelassieState();
}

class _werebTirSelassieState extends State<werebTirSelassie> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("\WerebTirSelassie").snapshots(),
