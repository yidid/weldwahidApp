...
class werebHidarArbaetuEnsesa extends StatefulWidget {
   werebHidarArbaetuEnsesa({super.key});

  @override
  State<werebHidarArbaetuEnsesa> createState() => _werebHidarArbaetuEnsesaState();
}

class _werebHidarArbaetuEnsesaState extends State<werebHidarArbaetuEnsesa> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebArbatuEnsesa").snapshots(),
