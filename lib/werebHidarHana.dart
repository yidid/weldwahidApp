...
class WerebHidarHana extends StatefulWidget {
   WerebHidarHana({super.key});

  @override
  State<WerebHidarHana> createState() => _WerebHidarHanaState();
}

class _WerebHidarHanaState extends State<WerebHidarHana> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHidarHana").snapshots(),
