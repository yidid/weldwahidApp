...
class werebGinbotMariam extends StatefulWidget {
   werebGinbotMariam({super.key});

  @override
  State<werebGinbotMariam> createState() => _werebGinbotMariamState();
}

class _werebGinbotMariamState extends State<werebGinbotMariam> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebginbotMariam").snapshots(),
