...
class WerebDebereTabor extends StatefulWidget {
   WerebDebereTabor({super.key});

  @override
  State<WerebDebereTabor> createState() => _WerebDebereTaborState();
}

class _WerebDebereTaborState extends State<WerebDebereTabor> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebDebereTabor").snapshots(),
