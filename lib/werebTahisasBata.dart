...
class werebTahisasBeata extends StatefulWidget {
   werebTahisasBeata({super.key});

  @override
  State<werebTahisasBeata> createState() => _werebTahisasBeataState();
}

class _werebTahisasBeataState extends State<werebTahisasBeata> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebTahisasBeata").snapshots(),
