...
class YeGinbotLideta extends StatefulWidget {
   YeGinbotLideta({super.key});

  @override
  State<YeGinbotLideta> createState() => _YeGinbotLidetaState();
}

class _YeGinbotLidetaState extends State<YeGinbotLideta> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeGibotLideta").snapshots(),
