...
class Yehitsanat extends StatefulWidget {
   Yehitsanat({super.key});

  @override
  State<Yehitsanat> createState() => _YehitsanatState();
}

class _YehitsanatState extends State<Yehitsanat> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('YehitsanatMezmur').snapshots(),
