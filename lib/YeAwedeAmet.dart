...
class YeAwedeAmet extends StatefulWidget {
   YeAwedeAmet({super.key});

  @override
  State<YeAwedeAmet> createState() => _YeAwedeAmetState();
}

class _YeAwedeAmetState extends State<YeAwedeAmet> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('YebealatMezmur').snapshots(),
