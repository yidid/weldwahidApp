...
class werebHidarKahenateSemay extends StatefulWidget {
   werebHidarKahenateSemay({super.key});

  @override
  State<werebHidarKahenateSemay> createState() => _werebHidarKahenateSemayState();
}

class _werebHidarKahenateSemayState extends State<werebHidarKahenateSemay> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHidarKahenateSemay").snapshots(),
