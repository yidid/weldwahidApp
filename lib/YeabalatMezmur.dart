...
class Yeabalat extends StatefulWidget {
   Yeabalat({super.key});

  @override
  State<Yeabalat> createState() => _YeabalatState();
}

class _YeabalatState extends State<Yeabalat> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('YeabalatMezmur').snapshots(),
