...
class werebTimket extends StatefulWidget {
   werebTimket({super.key});

  @override
  State<werebTimket> createState() => _werebTimketState();
}

class _werebTimketState extends State<werebTimket> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebTirTimket").snapshots(),
