...
class WerebTinsae extends StatefulWidget {
   WerebTinsae({super.key});

  @override
  State<WerebTinsae> createState() => _WerebTinsaeState();
}

class _WerebTinsaeState extends State<WerebTinsae> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebTinsae").snapshots(),
