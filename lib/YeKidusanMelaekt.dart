...
class YeKidusanMelaekt extends StatefulWidget {
   YeKidusanMelaekt({super.key});

  @override
  State<YeKidusanMelaekt> createState() => _YeKidusanMelaektState();
}

class _YeKidusanMelaektState extends State<YeKidusanMelaekt> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeLiyuLiyuKidusan").snapshots(),
