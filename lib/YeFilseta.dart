...
class YeFilseta extends StatefulWidget {
   YeFilseta({super.key});

  @override
  State<YeFilseta> createState() => _YeFilsetaState();
}

class _YeFilsetaState extends State<YeFilseta> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("Yefelseta Mezmur").snapshots(),
