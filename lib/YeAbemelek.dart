...
class YeAbemelek extends StatefulWidget {
   YeAbemelek({super.key});

  @override
  State<YeAbemelek> createState() => _YeAbemelekState();
}

class _YeAbemelekState extends State<YeAbemelek> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeAbemelek").snapshots(),
