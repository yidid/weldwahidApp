...
class werebTsge extends StatefulWidget {
   werebTsge({super.key});

  @override
  State<werebTsge> createState() => _werebTsgeState();
}

class _werebTsgeState extends State<werebTsge> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebTsige").snapshots(),
