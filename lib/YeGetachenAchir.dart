...
class YeGetachenAchirMezmur extends StatefulWidget {
   YeGetachenAchirMezmur({super.key});

  @override
  State<YeGetachenAchirMezmur> createState() => _YeGetachenAchirMezmurState();
}

class _YeGetachenAchirMezmurState extends State<YeGetachenAchirMezmur> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeGetachenAchirYemesganaMezmur").snapshots(),
