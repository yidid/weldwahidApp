...
class werebHidarTsion extends StatefulWidget {
   werebHidarTsion({super.key});

  @override
  State<werebHidarTsion> createState() => _werebHidarTsionState();
}

class _werebHidarTsionState extends State<werebHidarTsion> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHidarTsion").snapshots(),
