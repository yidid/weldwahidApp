...
class YeKidusYohanes extends StatefulWidget {
   YeKidusYohanes({super.key});

  @override
  State<YeKidusYohanes> createState() => _YeKidusYohanesState();
}

class _YeKidusYohanesState extends State<YeKidusYohanes> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidusYohanes").snapshots(),
