...
class YeKidusRufael extends StatefulWidget {
   YeKidusRufael({super.key});

  @override
  State<YeKidusRufael> createState() => _YeKidusRufaelState();
}

class _YeKidusRufaelState extends State<YeKidusRufael> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidusRufael").snapshots(),
