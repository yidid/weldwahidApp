...
class YeTinsae extends StatefulWidget {
   YeTinsae({super.key});

  @override
  State<YeTinsae> createState() => _YeTinsaeState();
}

class _YeTinsaeState extends State<YeTinsae> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('YeTinsaeMezmur').snapshots(),
