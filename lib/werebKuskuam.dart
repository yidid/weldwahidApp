...
class werebHidarKuskuam extends StatefulWidget {
   werebHidarKuskuam({super.key});

  @override
  State<werebHidarKuskuam> createState() => _werebHidarKuskuamState();
}

class _werebHidarKuskuamState extends State<werebHidarKuskuam> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebHidarKuskuam").snapshots(),
