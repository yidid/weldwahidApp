...
class WerebMeyaziyaEyakem extends StatefulWidget {
   WerebMeyaziyaEyakem({super.key});

  @override
  State<WerebMeyaziyaEyakem> createState() => _WerebMeyaziyaEyakemState();
}

class _WerebMeyaziyaEyakemState extends State<WerebMeyaziyaEyakem> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebMiyaziyaEyakem").snapshots(),
