...
class YeLikeArdet extends StatefulWidget {
   YeLikeArdet({super.key});

  @override
  State<YeLikeArdet> createState() => _YeLikeArdetState();
}

class _YeLikeArdetState extends State<YeLikeArdet> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("Yelikearde'thenokmogesmezmurat").snapshots(),
