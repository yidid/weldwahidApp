...
class YeKidaneMiheret extends StatefulWidget {
   YeKidaneMiheret({super.key});

  @override
  State<YeKidaneMiheret> createState() => _YeKidaneMiheretState();
}

class _YeKidaneMiheretState extends State<YeKidaneMiheret> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidaneMiheret").snapshots(),
