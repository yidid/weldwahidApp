...
class YeKidistArsema extends StatefulWidget {
   YeKidistArsema({super.key});

  @override
  State<YeKidistArsema> createState() => _YeKidistArsemaState();
}

class _YeKidistArsemaState extends State<YeKidistArsema> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("yekidist arsema mezmuroch").snapshots(),
