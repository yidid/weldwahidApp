...
class WerebNehaseKidaneMiheret extends StatefulWidget {
   WerebNehaseKidaneMiheret({super.key});

  @override
  State<WerebNehaseKidaneMiheret> createState() => _WerebNehaseKidaneMiheretState();
}

class _WerebNehaseKidaneMiheretState extends State<WerebNehaseKidaneMiheret> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebNehaseKidaneMiheret").snapshots(),
