...
class AbrehaWeAtsbha extends StatefulWidget {
   AbrehaWeAtsbha({super.key});

  @override
  State<AbrehaWeAtsbha> createState() => _AbrehaWeAtsbhaState();
}

class _AbrehaWeAtsbhaState extends State<AbrehaWeAtsbha> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeAberhaWeAtsbeha").snapshots(),
