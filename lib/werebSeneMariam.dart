...
class werebSeneMariam extends StatefulWidget {
   werebSeneMariam({super.key});

  @override
  State<werebSeneMariam> createState() => _werebSeneMariamState();
}

class _werebSeneMariamState extends State<werebSeneMariam> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebSeneMariam").snapshots(),
