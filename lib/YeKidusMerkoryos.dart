...
class YeKidusMerkoryos extends StatefulWidget {
   YeKidusMerkoryos({super.key});

  @override
  State<YeKidusMerkoryos> createState() => _YeKidusMerkoryosState();
}

class _YeKidusMerkoryosState extends State<YeKidusMerkoryos> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidusMerkoreyosMezmur").snapshots(),
