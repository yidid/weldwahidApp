...
class YeZemariAddisu extends StatefulWidget {
   YeZemariAddisu({super.key});

  @override
  State<YeZemariAddisu> createState() => _YeZemariAddisuState();
}

class _YeZemariAddisuState extends State<YeZemariAddisu> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeAddisuNiguse").snapshots(),
