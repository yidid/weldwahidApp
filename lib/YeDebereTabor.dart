...
class YeDebereTabor extends StatefulWidget {
   YeDebereTabor({super.key});

  @override
  State<YeDebereTabor> createState() => _YeDebereTaborState();
}

class _YeDebereTaborState extends State<YeDebereTabor> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeDebereTabor").snapshots(),
