...
class YeKidusMikael extends StatefulWidget {
   YeKidusMikael({super.key});

  @override
  State<YeKidusMikael> createState() => _YeKidusMikaelState();
}

class _YeKidusMikaelState extends State<YeKidusMikael> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidusMikael").snapshots(),
