...
class YeKidusGebriel extends StatefulWidget {
   YeKidusGebriel({super.key});

  @override
  State<YeKidusGebriel> createState() => _YeKidusGebrielState();
}

class _YeKidusGebrielState extends State<YeKidusGebriel> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidusGeberiel").snapshots(),
