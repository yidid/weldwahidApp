...
class TahisasAbaSamuel extends StatefulWidget {
   TahisasAbaSamuel({super.key});

  @override
  State<TahisasAbaSamuel> createState() => _TahisasAbaSamuelState();
}

class _TahisasAbaSamuelState extends State<TahisasAbaSamuel> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("TahesasAbaSamuel").snapshots(),
