...
class YeTimket extends StatefulWidget {
  ...
  @override
  State<YeTimket> createState() => _YeTimketState();
}

class _YeTimketState extends State<YeTimket> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('YeTimketMezmur').snapshots(),
