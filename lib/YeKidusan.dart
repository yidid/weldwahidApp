...
class YeKidusan extends StatefulWidget {
   YeKidusan({super.key});

  @override
  State<YeKidusan> createState() => _YeKidusanState();
}

class _YeKidusanState extends State<YeKidusan> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("YeKidusanMezmurat").snapshots(),
