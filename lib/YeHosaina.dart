...
class YeHosina extends StatefulWidget {
   YeHosina({super.key});

  @override
  State<YeHosina> createState() => _YeHosinaState();
}

class _YeHosinaState extends State<YeHosina> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('YeHosainaMezmur').snapshots(),
