...
class WerebAddisAmet extends StatefulWidget {
   WerebAddisAmet({super.key});

  @override
  State<WerebAddisAmet> createState() => _WerebAddisAmetState();
}

class _WerebAddisAmetState extends State<WerebAddisAmet> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("WerebAddisAmet").snapshots(),
