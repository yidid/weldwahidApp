...
class werebHosaina extends StatefulWidget {
   werebHosaina({super.key});

  @override
  State<werebHosaina> createState() => _werebHosainaState();
}

class _werebHosainaState extends State<werebHosaina> {
   var height,width;
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor: HexColor("#1d4516"),
      ...
      StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("werebHosaina").snapshots(),
